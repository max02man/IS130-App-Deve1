' Project name:         Concentration Game Project
...
Public Class MainForm
    ...
    Private Sub MainForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ' the words
        Dim filelist() As String = {"words1.txt", "words2.txt", "words3.txt", "words4.txt"}

        Dim randgen As New Random
        Dim filename As String =
            filelist(randgen.Next(0, 4))
        ...
        Else
            MessageBox.Show("can't find " & filename, "missing File",
    ...
    Private Sub TestForMatch(ByVal sender As Object, ByVal e As System.EventArgs) Handles Label1.Click,
